...
* social scientists predominantly (exclusively?) apply parametric spatial regression models to _control_ for spatial misspecification
...
* especially eigenvector-based spatial filtering (e.g., Griffith 1996 & 2003) is of practical utility
...
* include a proxy variable for spatial effects in the regression's systematic part
